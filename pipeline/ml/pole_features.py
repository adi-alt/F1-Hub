...
(tried and rejected for the finish/pace models), FP deltas vary per driver within the same race, so
they're a legitimate ranking signal, and they're knowable before qualifying since practice always
runs first.
"""
