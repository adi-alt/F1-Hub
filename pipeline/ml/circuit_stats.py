...
Leakage-safety rule is the same one used everywhere else in this pipeline, just chronological
across years instead of within a season: a race's circuit features only ever come from strictly
earlier (year, round) pairs at that location.
"""
