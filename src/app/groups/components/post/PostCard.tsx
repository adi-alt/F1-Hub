...
export function PostCard({
  ...
  return (
    ...
    >
      ...
      <div className={variant === "compact" ? "" : "mt-1.5"}>
      ...
      <PostActionBar
        ...
        trailing={
          kindChip ? (
            <span className="block truncate rounded-full border border-white/[0.08] bg-white/[0.03] px-2.5 py-1 text-[10.5px] font-medium text-neutral-400">{kindChip}</span>
          ) : undefined
        }
      />
