...
/** Mirrors GroupCard/PublicGroupCard's exact shape (banner height 100, -mt-6 icon overlap, name +
 * description + metadata + activity lines) so the grid doesn't reflow when real cards swap in. */
