...
const FIXED_CONTEXT: HomepageContextData = {
  ...
  communityPosts: [],
  favoriteDrivers: [{ name: "Lewis Hamilton", rank: 2, points: 163, teamName: "Ferrari", circuit: { appearances: 19, wins: 5, podiums: 8, bestFinish: 1, avgFinish: 5.9 } }],
  favoriteTeams: [{ name: "Mercedes", rank: 1, points: 365, circuit: { appearances: 16, wins: 5, podiums: 13, bestFinish: 1 } }],
