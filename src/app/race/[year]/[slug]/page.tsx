 ...
 * from." Which pipeline backs it follows the exact same seasonStatus split SeasonDetail's own
 * data layer uses: the live season (real prediction/pole/simulation data) vs. every other year
 * (archive_races - richer completed-race data, real pit-stops/qualifying/laps). */
export default async function RacePage({ params }: { params: Promise<{ year: string; slug: string }> }) {
