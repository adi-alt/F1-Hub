...
export function ClassificationTable({
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-white/[0.07] bg-[var(--f1-carbon)]/50">
      {/* Capped to roughly 10 rows, then scrolls - same "don't let a 20-driver field push
          everything below it down the page" reasoning as the Season page's own Championship
