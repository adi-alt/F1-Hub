 ...
 * page* (SeasonFavoritesContext already updates that instantly, optimistically, no refresh), but
 * this is what closes the gap for a favorite changed somewhere else: another tab, another device,
 * or the Archive/Profile pages, none of which this page's own state would otherwise ever see.
 * getUserProfile isn't wrapped in unstable_cache and the page already reads cookies() (forces
 * dynamic rendering), so a plain refresh is enough - no separate cache-tag busting needed.
 */
